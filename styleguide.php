...
get_header(); ?>
    ...
    <div class="column row"><div class="row collapse">
      ...
      <div class="large-3 medium-4 columns">
        <ul class="vertical tabs" data-tabs id="ss-sections">
            <li class="tabs-title is-active" aria-selected="true"><a href="#the-grid">The Grid</a></li>
            <li class="tabs-title"><a href="#colors">Colors</a></li>
            <li class="tabs-title"><a href="#typography">Typography</a></li>
            <li class="tabs-title"><a href="#buttons">Buttons</a></li>
            <li class="tabs-title"><a href="#forms">Forms</a></li>
        </ul>
      </div>

      <div class="large-9 medium-8 columns" data-tabs-content="ss-sections">
        <div class="tabs-content vertical">
            <section class="tabs-panel is-active" id="the-grid">
...
<div class="row display">
  ...
  <div class="small-9 columns">9, last</div>
            ...
            <section class="tabs-panel " id="colors">
  ...
  <div class="column">
    <div class="color-block">
      ...
      #0a0a0a
            ...
            <section class="tabs-panel " id="typography">
...
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic quibusdam ratione sunt dolorum, qui illo maxime doloremque accusantium cum libero eum, a optio odio placeat debitis ullam aut non distinctio.</p>
            ...
            <section class="tabs-panel " id="buttons">
...
<a href="#" class="secondary tiny button">Tiny button</a></div>
            ...
            <section class="tabs-panel " id="forms">
